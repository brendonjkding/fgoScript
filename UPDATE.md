...
## v1.8.5
* 仅在低版本触摸精灵下显示启动中提示
* 现在选择任意助战与礼装时仅选择好友也会生效
* 现在可以在关卡中途启动脚本
* 移除了抽友情时不对的提示
* 修复重启游戏后可能未自动重进关卡的问题
* 可能修复了复数宝具释放
## v1.8.4
* 试验性支持三回合之后的宝具与技能释放以及任意回合任意顺序的复数宝具释放(需手动编辑生成的新脚本文件)
* 改正翻车时停止时机为撤退前
## v1.8.3
* 新增闪退后自动开启游戏并继续功能
## v1.8.2
* 进一步适配台服(经验证可正常工作功能：打本、抽无限池)
## v1.8.1
* 初步重新支持台服
## v1.8.0
* 改进刷助战功能(不选系统助战)
...
* 尝试修复连续出击卡住的问题
## v1.6.6
* 提高代码的可读性(无功能性改变，理论上兼容以前生成的脚本，如有问题重新生成即可)
## v1.6.5
* 适配抽无限池功能
* 适配刷助战功能
## v1.6.4
